...
export default defineConfig({
  ...
  projects: [
    ...
    /*
     * Mobile viewports are not optional here: scores get entered on a phone at
     * the range, so the tap keypad has to be exercised on a real touch device
     * profile. iPhone/WebKit also lacks BarcodeDetector, which the QR merge
     * feature must fall back from.
     */
    {
      name: 'Mobile Chrome',
      use: {
